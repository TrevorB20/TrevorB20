...
| Constructing Boto3 to Allow Python and AWS Lambda to Stop Ec2 Instances on a schedule                    | <a href="[https://medium.com/@TrevorB4135/secure-remote-administration-and-troubleshooting-of-ec2-instances-using-ssh-f0efc366c594](https://medium.com/@TrevorB4135/constructing-boto3-to-allow-python-and-aws-lambda-to-stop-ec2-instances-on-a-schedule-fd5cba8626d0)">Constructing Boto3 to Allow Python and AWS Lambda to Stop Ec2 Instances on a schedule
